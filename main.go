...
func main() {
	...
	router.GET("/.well-known/acme-challenge/oQ6616oJcfwgJfoejseB1fqo-tTj7rz7Fo2yotDWVls", func(c *gin.Context) {
		c.String(http.StatusOK, "oQ6616oJcfwgJfoejseB1fqo-tTj7rz7Fo2yotDWVls.vFVx33rpM-z2CkG8kIUIoqNLIJ_GIC7TCte2t3N4-SE")
	})
